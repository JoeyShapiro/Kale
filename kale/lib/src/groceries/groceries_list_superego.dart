...
class _GroceryListState extends State<GroceryList> {
  ...
  void initState() {
    ...
    groceriesListController.loadSettings();
    ...
    // items = groceriesListController.items;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(alignment: Alignment.bottomCenter, children: [
        ...
        ListenableBuilder(
            listenable: groceriesListController,
            builder: (BuildContext context, Widget? child) {
              items = groceriesListController.items; // TODO hmmmm
